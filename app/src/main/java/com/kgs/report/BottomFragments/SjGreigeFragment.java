...
public class SjGreigeFragment extends Fragment {

    String webUrlInvoice = baseurl+"android/list_sj.php";
    private ProgressBar progressBar;

    private FrameLayout webView_container;
    public static WebView webViewSj;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_sj_greige, container, false);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        webViewSj = view.findViewById(R.id.webViewId);
        webViewSj.getSettings().setJavaScriptEnabled(true);
        webViewSj.loadUrl(webUrlInvoice);

        WebSettings webSettings = webViewSj.getSettings();
        webSettings.setJavaScriptEnabled(true);
        webViewSj.getSettings().setBuiltInZoomControls(true);
        webViewSj.getSettings().setDisplayZoomControls(false);
        ...
        webViewSj.setDownloadListener(new DownloadListener() {
            @Override
        ...
        webViewSj.setOnKeyListener(new View.OnKeyListener(){
        ...
        webViewSj.setWebViewClient(new WebViewClient() {
            @Override
