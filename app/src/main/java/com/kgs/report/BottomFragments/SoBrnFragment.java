...
public class SoBrnFragment extends Fragment {
    String webUrlSoBrn= baseurl+"android/list_so_brn.php";
    private ProgressBar progressBar;
    public static WebView webViewSOBRN;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_so_brn, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        webViewSOBRN = view.findViewById(R.id.webViewId);
        webViewSOBRN.getSettings().setJavaScriptEnabled(true);
        webViewSOBRN.getSettings().setBuiltInZoomControls(true);
        webViewSOBRN.getSettings().setDisplayZoomControls(false);
        webViewSOBRN.loadUrl(webUrlSoBrn);
        requestPermission();
        webViewSOBRN.setDownloadListener(new DownloadListener() {
            @Override
        ...
        //set back webview
        webViewSOBRN.setOnKeyListener(new View.OnKeyListener(){

            public boolean onKey(View v, int keyCode, KeyEvent event) {
                if (keyCode == android.view.KeyEvent.KEYCODE_BACK
                        && event.getAction() == MotionEvent.ACTION_UP
                        && webViewSOBRN.canGoBack()) {
                    webViewSOBRN.goBack();
                    return true;
                }
        ...
        webViewSOBRN.setWebViewClient(new WebViewClient() {
            @Override
