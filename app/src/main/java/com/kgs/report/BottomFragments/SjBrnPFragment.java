...
public class SjBrnPFragment extends Fragment {

    String webUrlBrnP = baseurl+"android/list_sj_brn.php";
    private ProgressBar progressBar;

    private FrameLayout webView_container;
    public static WebView webViewSjBrnP;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_sj_brn_p, container, false);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        webViewSjBrnP = view.findViewById(R.id.webViewId);
        webViewSjBrnP.getSettings().setJavaScriptEnabled(true);
        webViewSjBrnP.loadUrl(webUrlBrnP);
        webViewSjBrnP.getSettings().setBuiltInZoomControls(true);
        webViewSjBrnP.getSettings().setDisplayZoomControls(false);

        WebSettings webSettings = webViewSjBrnP.getSettings();
        ...
        webViewSjBrnP.setDownloadListener(new DownloadListener() {
            @Override
        ...
        webViewSjBrnP.setOnKeyListener(new View.OnKeyListener(){

            public boolean onKey(View v, int keyCode, KeyEvent event) {
                if (keyCode == KeyEvent.KEYCODE_BACK
                        && event.getAction() == MotionEvent.ACTION_UP
                        && webViewSjBrnP.canGoBack()) {
                    webViewSjBrnP.goBack();
                    return true;
                }
        ...
        webViewSjBrnP.setWebViewClient(new WebViewClient() {
            @Override
