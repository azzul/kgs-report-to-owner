...
public class PayFragment extends Fragment {
    String webUrlInvoice = baseurl+"android/pembayaran_piutang.php";
    private ProgressBar progressBar;
    private FrameLayout webView_container;
    public static WebView webViewPay;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        webViewPay = view.findViewById(R.id.webViewId);
        webViewPay.getSettings().setJavaScriptEnabled(true);
        webViewPay.getSettings().setBuiltInZoomControls(true);
        webViewPay.getSettings().setDisplayZoomControls(false);
        webViewPay.loadUrl(webUrlInvoice);
        ...
        //download function
        webViewPay.setDownloadListener(new DownloadListener() {
            @Override
        ...
        webViewPay.setOnKeyListener(new View.OnKeyListener(){

            public boolean onKey(View v, int keyCode, KeyEvent event) {
                if (keyCode == KeyEvent.KEYCODE_BACK
                        && event.getAction() == MotionEvent.ACTION_UP
                        && webViewPay.canGoBack()) {
                    webViewPay.goBack();
                    return true;
                }
