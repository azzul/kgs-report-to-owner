...
public class SoFragment extends Fragment {
    String webUrlMessage = baseurl+"android/list_so_kgs.php";
    private ProgressBar progressBar;
    public static WebView webViewSO;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        webViewSO = view.findViewById(R.id.webViewId);
        webViewSO.getSettings().setJavaScriptEnabled(true);
        webViewSO.getSettings().setBuiltInZoomControls(true);
        webViewSO.getSettings().setDisplayZoomControls(false);
        webViewSO.loadUrl(webUrlMessage);
        requestPermission();

        webViewSO.setDownloadListener(new DownloadListener() {
            @Override
        ...
        //set back webview
        webViewSO.setOnKeyListener(new View.OnKeyListener(){
        ...
        webViewSO.setWebViewClient(new WebViewClient() {
            @Override
