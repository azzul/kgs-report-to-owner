...
import com.kgs.report.BottomFragments.OnComplete;
...
public class InvoiceFragment extends Fragment {
    String webUrlInvoice = baseurl+"android/list_invoice.php";
    private ProgressBar progressBar;

    private FrameLayout webView_container;
    public static WebView webViewInv;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        webViewInv = view.findViewById(R.id.webViewId);
        webViewInv.getSettings().setJavaScriptEnabled(true);
        webViewInv.loadUrl(webUrlInvoice);

        WebSettings webSettings = webViewInv.getSettings();
        webSettings.setJavaScriptEnabled(true);
        progressBar = view.findViewById(R.id.progress_bar);
        webViewInv.getSettings().setBuiltInZoomControls(true);
        webViewInv.getSettings().setDisplayZoomControls(false);
        ...
        webViewInv.setDownloadListener(new DownloadListener() {
            @Override
        ...
        webViewInv.setOnKeyListener(new View.OnKeyListener(){

            public boolean onKey(View v, int keyCode, KeyEvent event) {
                if (keyCode == KeyEvent.KEYCODE_BACK
                        && event.getAction() == MotionEvent.ACTION_UP
                        && webViewInv.canGoBack()) {
                    webViewInv.goBack();
                    return true;
                }
        ...
        webViewInv.setWebViewClient(new WebViewClient() {
            @Override
