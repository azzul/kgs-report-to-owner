...
public class ReportSoBrnFragment extends Fragment {
    @SuppressLint("StaticFieldLeak")
    public static WebView mWebViewBrn; //make it public for access globally
    String webUrlReportBrn = baseurl+"android/index_brn.php";
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        mWebViewBrn = view.findViewById(R.id.webViewIdHome);
        mWebViewBrn.getSettings().setJavaScriptEnabled(true);
        WebSettings webSettings = mWebViewBrn.getSettings();
        webSettings.setJavaScriptEnabled(true);
        mWebViewBrn.getSettings().setBuiltInZoomControls(true);
        mWebViewBrn.getSettings().setDisplayZoomControls(false);
        if (savedInstanceState == null)
        {
            mWebViewBrn.loadUrl(webUrlReportBrn);
        }
        requestPermission();


        mWebViewBrn.addJavascriptInterface(new WebAppInterface(getActivity()), "Android");
        //fungsi untuk download-lempar ke browser
        mWebViewBrn.setDownloadListener(new DownloadListener() {
            @Override
        ...
        mWebViewBrn.setWebViewClient(new ReportSoBrnFragment.CustomWebViewBrnClient());
        mWebViewBrn.setOnKeyListener(new View.OnKeyListener(){

            public boolean onKey(View v, int keyCode, KeyEvent event) {
                if (keyCode == android.view.KeyEvent.KEYCODE_BACK
                        && event.getAction() == MotionEvent.ACTION_UP
                        && mWebViewBrn.canGoBack()) {
                    mWebViewBrn.goBack();
                    return true;
                }
        ...
        mWebViewBrn.setWebViewClient(new WebViewClient() {
            @Override
    ...
    public void onSaveInstanceState(Bundle outState)
    {
        ...
        mWebViewBrn.saveState(outState);
    }


    private class CustomWebViewBrnClient extends WebViewClient {
        ...
        public void onPageFinished(WebView view, String url) {
            ...
            onPageStarted = false;
            mWebViewBrn.postDelayed(hideLoadingRunnable, 1000);
