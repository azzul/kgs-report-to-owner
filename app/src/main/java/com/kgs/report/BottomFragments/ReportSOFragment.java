...
public class ReportSOFragment extends Fragment {
    @SuppressLint("StaticFieldLeak")
    public static WebView mWebView; //make it public for access globally
    String webUrlHome = baseurl+"android/";
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        webView_container.setAlpha(0.9f);
    ...
    private class CustomWebViewClient extends WebViewClient {
        ...
        public void onPageFinished(WebView view, String url) {
            ...
            onPageStarted = false;
            mWebView.postDelayed(hideLoadingRunnable, 1000);
