...
public class SjBrnSkrFragment extends Fragment {

    String webUrlBrnP = baseurl+"android/list_sj_brn_skr.php";
    private ProgressBar progressBar;

    private FrameLayout webView_container;
    public static WebView webViewSjBrnSkr;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_sj_brn_skr, container, false);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        webViewSjBrnSkr = view.findViewById(R.id.webViewId);
        webViewSjBrnSkr.getSettings().setJavaScriptEnabled(true);
        webViewSjBrnSkr.loadUrl(webUrlBrnP);
        webViewSjBrnSkr.getSettings().setBuiltInZoomControls(true);
        webViewSjBrnSkr.getSettings().setDisplayZoomControls(false);

        WebSettings webSettings = webViewSjBrnSkr.getSettings();
        ...
        webViewSjBrnSkr.setDownloadListener(new DownloadListener() {
            @Override
        ...
        webViewSjBrnSkr.setOnKeyListener(new View.OnKeyListener(){

            public boolean onKey(View v, int keyCode, KeyEvent event) {
                if (keyCode == KeyEvent.KEYCODE_BACK
                        && event.getAction() == MotionEvent.ACTION_UP
                        && webViewSjBrnSkr.canGoBack()) {
                    webViewSjBrnSkr.goBack();
                    return true;
                }
        ...
        webViewSjBrnSkr.setWebViewClient(new WebViewClient() {
            @Override
