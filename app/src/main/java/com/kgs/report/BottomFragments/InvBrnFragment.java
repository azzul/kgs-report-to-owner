...
public class InvBrnFragment extends Fragment {
    String webUrlInvoiceBrn = baseurl+"android/list_invoice_brn.php";
    private ProgressBar progressBar;

    private FrameLayout webView_container;
    public static WebView webViewInvBrn;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_inv_brn, container, false);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        webViewInvBrn = view.findViewById(R.id.webViewId);
        webViewInvBrn.getSettings().setJavaScriptEnabled(true);
        webViewInvBrn.loadUrl(webUrlInvoiceBrn);

        WebSettings webSettings = webViewInvBrn.getSettings();
        webSettings.setJavaScriptEnabled(true);
        webViewInvBrn.getSettings().setBuiltInZoomControls(true);
        webViewInvBrn.getSettings().setDisplayZoomControls(false);
        ...
        webViewInvBrn.setDownloadListener(new DownloadListener() {
            @Override
        ...
        webViewInvBrn.setOnKeyListener(new View.OnKeyListener(){

            public boolean onKey(View v, int keyCode, KeyEvent event) {
                if (keyCode == KeyEvent.KEYCODE_BACK
                        && event.getAction() == MotionEvent.ACTION_UP
                        && webViewInvBrn.canGoBack()) {
                    webViewInvBrn.goBack();
                    return true;
                }
        ...
        webViewInvBrn.setWebViewClient(new WebViewClient() {
            @Override
