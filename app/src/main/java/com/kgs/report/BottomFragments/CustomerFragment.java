...
public class CustomerFragment extends Fragment {
    String webUrlCustomer = baseurl+"android/master_cust.php";
    private ProgressBar progressBar;

    private FrameLayout webView_container;
    public static WebView webViewCustomer;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        webViewCustomer = view.findViewById(R.id.webViewId);
        webViewCustomer.getSettings().setJavaScriptEnabled(true);
        webViewCustomer.getSettings().setBuiltInZoomControls(true);
        webViewCustomer.getSettings().setDisplayZoomControls(false);
        webViewCustomer.loadUrl(webUrlCustomer);

        WebSettings webSettings = webViewCustomer.getSettings();
        ...
        webViewCustomer.setDownloadListener(new DownloadListener() {
            @Override
        ...
        webViewCustomer.setOnKeyListener(new View.OnKeyListener(){

            public boolean onKey(View v, int keyCode, KeyEvent event) {
                if (keyCode == KeyEvent.KEYCODE_BACK
                        && event.getAction() == MotionEvent.ACTION_UP
                        && webViewCustomer.canGoBack()) {
                    webViewCustomer.goBack();
                    return true;
                }
        ...
        webViewCustomer.setWebViewClient(new WebViewClient() {
            @Override
