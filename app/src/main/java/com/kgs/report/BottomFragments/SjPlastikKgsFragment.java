...
public class SjPlastikKgsFragment extends Fragment {

    String webUrlInvoice = baseurl+"android/list_sj_plastik.php";
    private ProgressBar progressBar;

    private FrameLayout webView_container;
    public static WebView webViewSjPlastik;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_sj_plastik_kgs, container, false);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        webViewSjPlastik = view.findViewById(R.id.webViewId);
        webViewSjPlastik.getSettings().setJavaScriptEnabled(true);
        webViewSjPlastik.loadUrl(webUrlInvoice);
        webViewSjPlastik.getSettings().setBuiltInZoomControls(true);
        webViewSjPlastik.getSettings().setDisplayZoomControls(false);

        WebSettings webSettings = webViewSjPlastik.getSettings();
        ...
        webViewSjPlastik.setDownloadListener(new DownloadListener() {
            @Override
        ...
        webViewSjPlastik.setOnKeyListener(new View.OnKeyListener(){

            public boolean onKey(View v, int keyCode, KeyEvent event) {
                if (keyCode == KeyEvent.KEYCODE_BACK
                        && event.getAction() == MotionEvent.ACTION_UP
                        && webViewSjPlastik.canGoBack()) {
                    webViewSjPlastik.goBack();
                    return true;
                }
        ...
        webViewSjPlastik.setWebViewClient(new WebViewClient() {
            @Override
