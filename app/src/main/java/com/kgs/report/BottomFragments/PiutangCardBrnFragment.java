...
public class PiutangCardBrnFragment extends Fragment {

    String webUrlCardBrn = baseurl+"android/kartu_piutang_brn.php";
    private ProgressBar progressBar;
    private FrameLayout webView_container;
    public static WebView webViewCardBrn;
    OnComplete onComplete;
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        return inflater.inflate(R.layout.fragment_piutang_card_brn, container, false);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        webViewCardBrn = view.findViewById(R.id.webViewId);
        webViewCardBrn.getSettings().setJavaScriptEnabled(true);
        webViewCardBrn.getSettings().setBuiltInZoomControls(true);
        webViewCardBrn.getSettings().setDisplayZoomControls(false);
        webViewCardBrn.loadUrl(webUrlCardBrn);
        ...
        webViewCardBrn.setWebViewClient(new WebViewClient() {
            @Override
        ...
        webViewCardBrn.setDownloadListener(new DownloadListener() {
            @Override
        ...
        webViewCardBrn.setOnKeyListener(new View.OnKeyListener(){

            public boolean onKey(View v, int keyCode, KeyEvent event) {
                if (keyCode == KeyEvent.KEYCODE_BACK
                        && event.getAction() == MotionEvent.ACTION_UP
                        && webViewCardBrn.canGoBack()) {
                    webViewCardBrn.goBack();
                    return true;
                }
