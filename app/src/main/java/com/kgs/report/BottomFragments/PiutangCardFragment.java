...
import static com.kgs.report.BottomFragments.PayFragment.webViewPay;
...
public class PiutangCardFragment extends Fragment {
    String webUrlInvoice = baseurl+"android/kartu_piutang.php";
    private ProgressBar progressBar;
    private FrameLayout webView_container;
    public static WebView webViewCard;
    OnComplete onComplete;
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        return inflater.inflate(R.layout.fragment_piutang_card, container, false);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        webViewCard = view.findViewById(R.id.webViewId);
        ...
        webViewCard.loadUrl(webUrlInvoice);
        ...
        webViewCard.setDownloadListener(new DownloadListener() {
            @Override
        ...
        webViewCard.setOnKeyListener(new View.OnKeyListener(){

            public boolean onKey(View v, int keyCode, KeyEvent event) {
                if (keyCode == KeyEvent.KEYCODE_BACK
                        && event.getAction() == MotionEvent.ACTION_UP
                        && webViewCard.canGoBack()) {
                    webViewCard.goBack();
                    return true;
                }
