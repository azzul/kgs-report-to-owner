...
public class ArmadaFragment extends Fragment {
    ...
    String webUrlArmada = baseurl+"android/master_armada.php";
    private ProgressBar progressBar;

    private FrameLayout webView_container;
    public static WebView webViewArmada;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        webViewArmada = view.findViewById(R.id.webViewId);
        webViewArmada.getSettings().setJavaScriptEnabled(true);
        webViewArmada.getSettings().setBuiltInZoomControls(true);
        webViewArmada.getSettings().setDisplayZoomControls(false);
        webViewArmada.loadUrl(webUrlArmada);

        WebSettings webSettings = webViewArmada.getSettings();
        ...
        webViewArmada.setDownloadListener(new DownloadListener() {
            @Override
        ...
        webViewArmada.setOnKeyListener(new View.OnKeyListener(){

            public boolean onKey(View v, int keyCode, KeyEvent event) {
                if (keyCode == KeyEvent.KEYCODE_BACK
                        && event.getAction() == MotionEvent.ACTION_UP
                        && webViewArmada.canGoBack()) {
                    webViewArmada.goBack();
                    return true;
                }
        ...
        webViewArmada.setWebViewClient(new WebViewClient() {
            @Override
